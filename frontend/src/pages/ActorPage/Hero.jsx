    ...
    <Box className={classes.root}>
      <Container maxWidth="md">
        <Box className={classes.container}>
          ...
          />
          <Typography variant="h3" sx={{ lineHeight: 1.15, fontSize: { xs: 24, sm: 40 } }}>
            {actor?.name}
          </Typography>
          {actor && (
          ...
          >
            <SendDirectMessageButton actorUri={actor.uri} color="secondary" />
            <FollowButton actorUri={actor.uri} color="secondary" />
          </Box>
        </Box>
      </Container>
    </Box>
